...
import type { ResumeProfile, ResumeData, UpdateResumeData } from "@/types/resume";
...
export const resumeService = {
  ...
  async upsertMasterResumeData(
    data: UpdateResumeData,
    userId: string | null = null
  ): Promise<ResumeData> {
    // Check if master resume row exists
