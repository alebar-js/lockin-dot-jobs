...
import { useRefactorData, useCreateJobPosting, useUpdateJobPostingData } from "@/lib/queries";
...
export function FloatingActionBar() {
  ...
  // Helper function to merge resume data
  ...
  }, [forkTitle, jobDescription, diffData.resolved, createJobPostingMutation, router, keepChangesData]);
